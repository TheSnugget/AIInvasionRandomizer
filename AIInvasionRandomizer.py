...
standardActionList = [invade,invade,invade,ally,ally,ally,sabotage,sabotage,research,research,build,build,terraform,terraform,mode,mode,advice,anarchy]
passiveActionList = [build,build,build,terraform,terraform,terraform,research,research,research,advice,advice,advice,mode,mode,invade,ally,sabotage,anarchy]
offensiveActionList = [invade,invade,invade,invade,ally,ally,ally,ally,sabotage,sabotage,advice,advice,mode,mode,research,build,terraform,anarchy]
chaosActionList = [anarchy,anarchy,anarchy,mode,mode,mode,research,research,sabotage,sabotage,build,build,terraform,terraform,advice,advice,invade,ally]
